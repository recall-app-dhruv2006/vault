  ...
  return (
    <div className="container max-w-4xl space-y-8 py-8">
      ...
      <section className="space-y-2">
        <p className="flex items-center gap-1.5 text-label text-muted-foreground"><Sparkles className="h-3.5 w-3.5" /> Summary <span className="text-caption">· Generated by Recall</span></p>
        {isEditing ? (
      ...
      {analysis && (
        <section className="space-y-2">
          <p className="flex items-center gap-1.5 text-label text-muted-foreground"><Sparkles className="h-3.5 w-3.5" /> Extracted details <span className="text-caption">· Generated by Recall</span></p>
